...
from angularPlasmid import angularPlasmid
from echarts import echartsSequence
from pdifmodulecharts import pdifmoduleechart
...
def singleThread(inFile, outdir, blastnPath, scriptsDir, circle):
    ...
    pdifDB = scriptsDir + '/redundant.seed.fa'
    if format:
        if blastnPath:
...
def compare(str1, scriptDir):
    pdifdatabase = scriptDir + '/pdifdatabase.fasta'
